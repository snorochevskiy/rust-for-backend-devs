...
* [Rust Rover](https://www.jetbrains.com/rust/) — очень мощая IDE от JetBrains специльно для Rust. Бесплатна для Open-Source разработки и обучения, но для коммерческий разработки придётся купить лицензию.
...
* выведение типов
* автодополнение
* переход к объявлению пременной/функции/типа
...
Основным фокусом Zed является производительность и эффективное использование апаратных ресурсов. Если вы чувствительны к задержкам в работе графических приложений, то обязательно попробуйте Zed.
...
В дереве файлов проекта, в левой части окна, выбирете файл src/main.rs, и в панели справа должно отобразиться содержимое файла.
