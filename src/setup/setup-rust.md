...
Установка Rust тулчейна осуществялется при помощи официальной утилиты [rustup](https://www.rust-lang.org/tools/install), а установка линкера и стандартной библиотеки C вариируется от операционной системы и C++ тулчейна.
