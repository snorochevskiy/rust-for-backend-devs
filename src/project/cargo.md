...
В большинстве языков программирования, система сборки поставляется отдельно от тулчейна самого языка. Например, в Java популярны Maven и Gradle, которые распостраняются отдельно от JDK. Но в случае с Rust, утилита `rustup` устанавливает систему сборки одновременно вместе с компилятор. И называется эта система сборки — Cargo.
