...
Также в крэйте serde_json определёно перечисление [Value](https://docs.rs/serde_json/latest/serde_json/enum.Value.html), которое по сути является отображением JSON типов на Rust перечисление.
