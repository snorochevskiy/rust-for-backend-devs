...
> 
> Также в стандартной библиотеке Rust есть свой канал [mpmc](https://doc.rust-lang.org/std/sync/mpmc/index.html), однако на данный момет (Rust 1.92) он доступен только в ночной сборке Rust.
