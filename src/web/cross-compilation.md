...
Так же, если вы работает под Linux, но версия GLIBC на вашей системе старше, чем версия GLIBC на целевом Linux сервере, то скорее всего, исполняемый бинарный файл собранный под вашу систему, так же не запуститься на целевом Linux сервере.
