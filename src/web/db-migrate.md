...
Таблица `_sqlx_migrations` является служебной таблицей SQLx, и хранит метаданные применённых миграций. Механизм миграции использует эту таблицу, чтобы знать какие миграции были уже выполнены. Таблица хранит номера применённых миграций, имена соответствующих выполненых файлов миграции, время выполнения, а также контрольную сумму файла миграции (нужна для проверки не был ли изменён "задним числом" файл от уже применённой миграции).
