...
Функциональность из крэйта axum-test понадобится только в тестах, поэтому мы объявили его в секции зависимостей для тестов — `[dev-dependencies]`.
...
// Этот модуль, содержащий тест, будет компилироватся только при запуске тестов.
#[cfg(test)]
mod test {
