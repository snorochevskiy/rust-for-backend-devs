...
Здесь мы просто воспользователись тем, что сложение любого числа с нулём даёт это же число. Поэтому мы привязываем все аргументы макроса к `$( $rest )*`, а в теле шаблона мы складываем `0` со всеми аргументами макроса.
