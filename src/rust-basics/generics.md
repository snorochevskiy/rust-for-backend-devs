...
> Но после компиляции информации о генерик тип-аргументах исчезает и не доступна во время работы программы.\
