...
Дело в том, что вотличие от C, где `;` означает конец <ins>текущего</ins> выражения, в Rust `;` служит разделителем <ins>между</ins> выражениями. То есть, например, выражение 
